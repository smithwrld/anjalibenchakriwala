...
export const HoverPeek = ({
    ...
    const lensMotionVariants = {
        ...
        exit: { opacity: 0, scale: 0.7, transition: { duration: 0.2, ease: "easeIn" as const } },
    };
                        ...
                        {isPeeking && (
                            ...
                            >
                                ...
                                <a
                                    ...
                                    className={cn(
                                        "relative block overflow-hidden rounded-xl bg-brand-bg-light", // Relative positioning is key for the absolute lens layer.
                                        "border border-brand-secondary/50",
                                        "shadow-xl hover:shadow-2xl transition-all duration-300",
                                        "p-1" // Tiny padding creates a nice inner border effect.
                                    )}
                                ...
                                >
                                    ...
                                    {imageLoadFailed ? (
                                        <div
                                            className="flex items-center justify-center bg-brand-secondary/10 text-brand-text-light/50 text-xs font-serif"
                                        ...
                                        <img
                                            ...
                                            className="block rounded-lg pointer-events-none bg-brand-secondary/10 align-top"
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <img
                                                        ...
                                                        width={peekWidth}
                                                        height={peekHeight}
                                                        className="block rounded-lg bg-brand-secondary/10 align-top" // Match base image styles.
