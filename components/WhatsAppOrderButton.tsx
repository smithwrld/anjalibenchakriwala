...
const WhatsAppOrderButton: React.FC<WhatsAppOrderButtonProps> = ({ productName, price }) => {
  const handleWhatsAppOrder = () => {
    const message = `Hi! I would like to order ${productName} (${price}). Please let me know the availability and delivery details.`;
